...
module.exports.getShaderSource = function(script) {
    var str = "";
...
module.exports.createWebGLContext = function(canvas, message) {
...
module.exports.createProgram = function(context, vertexShaderSource, fragmentShaderSource, message) {
